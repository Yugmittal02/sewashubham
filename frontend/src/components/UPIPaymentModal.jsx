...
const UPIPaymentModal = ({
  ...
  const handleAppSelect = (app) => {
    if (!upiConfig.isConfigured) {
      alert(
        "⚠️ UPI payment is not configured. Please contact the store owner."
      );
      return;
    }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
        ...
        {paymentMode === "razorpay" && !showQRCode && (
        ...
        {/* QR Code View - Only shown in manual mode */}
        {paymentMode === "manual" && showQRCode ? (
          <div className="px-6 pb-6">
            {/* QR Code Display */}
              ...
              <div className="px-6 pb-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {UPI_APPS.map((app) => (
                    ...
                    >
                      <div
                        className={`w-14 h-14 ${app.bgColor} rounded-2xl flex items-center justify-center text-2xl mb-3 mx-auto shadow-lg`}
                      >
                        {app.icon}
                      </div>
              ...
              <div className="px-6 pb-6">
                <div className="bg-gray-50 rounded-2xl p-4">
                  <p className="text-xs text-gray-500 text-center">
                    Supports all UPI apps including GPay, PhonePe, Paytm, BHIM,
                    Amazon Pay, WhatsApp Pay & more
                  </p>
                </div>
              </div>
            </>
